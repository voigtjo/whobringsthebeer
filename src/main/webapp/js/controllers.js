...
conferenceApp.controllers.controller('CreateConferenceCtrl',
    function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
        ...
        $scope.createConference = function (conferenceForm) {
            ...
            $scope.loading = true;
            console.log("### startDate= "+ $scope.conference.startDate);
...
///###///
conferenceApp.controllers.controller('ShowGroupCtrl', function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
...
///###///
conferenceApp.controllers.controller('GroupDetailCtrl', function ($scope, $log, $routeParams, HTTP_ERRORS) {
	$scope.group = {};
...
///###///
conferenceApp.controllers.controller('CreateGroupCtrl', function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
	...
	$scope.saveGroup = function (groupForm) {
		...
		console.log("groupForm.name= " + groupForm.name + ", groupForm.description=" + groupForm.description);
		gapi.client.group.saveGroup($scope.group.name, $scope.group.description).
		execute(function (resp) {
			$scope.$apply(function () {
				$scope.loading = false;
				if (resp.error) {
...
///###///
//conferenceApp.controllers.controller('ShowEventCtrl', function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
//
//	/**
//	 * Holds the status if the query is being executed.
//	 * @type {boolean}
...
//
/////###///
//conferenceApp.controllers.controller('EventDetailCtrl', function ($scope, $log, $routeParams, HTTP_ERRORS) {
//	$scope.event = {};
//
//	$scope.isUserAttending = false;
//
...
//
/////###///
//conferenceApp.controllers.controller('CreateEventCtrl', function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
//
//	/**
//	 * The conference object being edited in the page.
//	 * @type {{}|*}
