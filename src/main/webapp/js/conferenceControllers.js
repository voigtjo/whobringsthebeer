...
var conferenceAppControllers = angular.module('conferenceControllers', ['ui.bootstrap']);
 ...
 */
conferenceAppControllers.controller('CreateConferenceCtrl',
 ...
 */
conferenceAppControllers.controller('ShowConferenceCtrl', function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
 ...
 */
conferenceAppControllers.controller('ConferenceDetailCtrl', function ($scope, $log, $routeParams, HTTP_ERRORS) {
    $scope.conference = {};
 ...
 */
conferenceAppControllers.controller('DatepickerCtrl', function ($scope) {
