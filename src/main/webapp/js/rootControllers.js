...
var rootAppControllers = angular.module('rootControllers',['ui.bootstrap']);

rootAppControllers.controller('RootCtrl', function ($scope, $location, oauth2Provider) {
 ...
 *
 */
rootAppControllers.controller('OAuth2LoginModalCtrl',
